...
public class BonusItem : Item
{
    ...
    private void ExplodeBomb(bool explosion)
    {
        ...
        if (Cell.NeighbourRight && explosion)
        {
        ...
        {
            if (list[i].Item.View.name.Contains("itemBonusHorizontal"))
            {
                ExplodeHorizontalLine();
            }
            if (list[i].Item.View.name.Contains("itemBonusVertical"))
            {
                ExplodeVerticalLine();
            }
    ...
    private void ExplodeVerticalLine()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            if (list[i].Item.View.name.Contains("itemBonusBomb"))
            {
                ExplodeBomb(false);
            }
            if (!list[i].Item.View.name.Contains("itemBonusVertical"))
